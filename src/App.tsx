...
> {
        ...
        {({ getRootProps, getInputProps }) => (
          <div>
            ...
            <div
              ...
              onClick={() =>
                this.setState({ fullUpdate: false, openDownload: false })
              }
            >
              <div
                className="modal"
                id="download-result"
                style={{ display: this.state.openDownload ? "block" : "none" }}
              ...
              >
                ...
                <div className="download-grid">
                  <div>
                    <DownloadButton
                      filename={
                        this.state.shortcutData._filename || "download.shortcut"
                      }
                  ...
                  <div>
                    ...
                    <p className="details-text">
                      Open your Camera app and point it steady for 2-3 seconds
                      at this QR Code.
                      <br />
                      <br />
                      If nothing happens, QR Code scanning may not be enabled on
                      your device.
                    </p>
                  </div>
                </div>
            ...
            <div className="editor-window">
                ...
                <div>
                  <div className="result-details">
                    <div className="result-actions">
                      {this.state.shortcutData[0].WFWorkflowActions.length}{" "}
                      action
                      {this.state.shortcutData[0].WFWorkflowActions.length === 1
                        ? ""
                        : "s"}
                    </div>
                  </div>
                  <div
                    ...
                    id="open-download"
                    onClick={() =>
                      this.setState({ fullUpdate: false, openDownload: true })
                    }
                  >
              ...
              <div className="editor-container">
                ...
                >
                  ...
                  <div className="large-btn upload-btn" {...getRootProps()}>
                    <input {...getInputProps()} />
                    Upload Shortcut
                  </div>
                ...
                >
                  <div className="result-text">
                    Waited for {this.state.took.waitedFor}ms and then converted
                    in {this.state.took.convertedIn} ms.
                  </div>
  ...
  onChange(text: string) {
    ...
    if (!this.state.loading) {
      this.setState({ fileValue: text, loading: true, fullUpdate: false });
    }
    if (timeout) {
