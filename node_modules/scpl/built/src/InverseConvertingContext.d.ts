import { Attachment, Text, Shortcut, Action, ParameterType, List, Dictionary, Aggrandizements, AdjustOffset } from "./OutputData";
export declare class InverseConvertingContext {
    ...
    createAdjustOffsetAble(value: AdjustOffset): string;
